...
export default function PrivacyPage() {
  return <div className="min-h-screen bg-background flex flex-col"><MarketingNav /><LegalDocument
    ...
    footer={<><Link href="/terms" className="hover:underline">Terms of Service</Link><span>·</span><Link href="/" className="hover:underline">Home</Link><span>© 2020 AI Robots Inc.</span></>}
  /></div>;
}
