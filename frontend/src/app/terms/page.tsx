...
export default function TermsPage() {
  return <div className="min-h-screen bg-background flex flex-col"><MarketingNav /><LegalDocument
    ...
    footer={<><Link href="/privacy" className="hover:underline">Privacy Policy</Link><span>·</span><Link href="/" className="hover:underline">Home</Link><span>© 2020 AI Robots Inc.</span></>}
  /></div>;
}
