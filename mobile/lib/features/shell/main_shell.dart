      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            ...
            selectedIcon: CircleAvatar(radius: 11, backgroundColor: const Color(0xFF5E5CE6), child: Text(_userInitial, style: const TextStyle(fontSize: 10, color: Colors.white))),
            label: 'Account',
          ),
        ],
      ),
