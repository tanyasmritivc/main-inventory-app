      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            ...
            selectedIcon: CircleAvatar(radius: 11, backgroundColor: const Color(0xFF8E8E93), child: Text(_userInitial, style: const TextStyle(fontSize: 10, color: Colors.white))),
            label: 'Account',
          ),
        ],
      ),
