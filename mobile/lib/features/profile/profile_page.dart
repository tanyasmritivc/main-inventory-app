              ...
              children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(color: Color(0xFF40C8E0), fontSize: 15, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ],
                ),
                if (_editingProfile) ...[
                  ...
                  Wrap(
                    spacing: 10,
                    children: [
                      '#40C8E0', '#30D158', '#FF9F0A', '#FF375F',
                      '#BF5AF2', '#40C8E0', '#FF6B35', '#636366',
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.people_alt_rounded,
                              color: Color(0xFF40C8E0), size: 18),
                          SizedBox(width: 12),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
