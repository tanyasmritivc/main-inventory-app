...
class _SharedInventoryPageState extends State<SharedInventoryPage>
  ...
  Color _colorForName(String name) {
    const colors = [
      Color(0xFF64D2FF), Color(0xFF30D158), Color(0xFFFF9F0A),
      Color(0xFFFF375F), Color(0xFFBF5AF2), Color(0xFF64D2FF),
    ];
      ...
      builder: (sheetContext) => SafeArea(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            ListTile(leading: const Icon(Icons.fact_check_outlined, color: Color(0xFF64D2FF)), title: const Text('Build Readiness'), onTap: () { Navigator.pop(sheetContext); _openBuildReadiness(); }),
            ListTile(leading: const Icon(Icons.inventory_2_outlined, color: Color(0xFF64D2FF)), title: const Text('Project Kits'), onTap: () { Navigator.pop(sheetContext); _openProjectKits(); }),
          ]),
        ),
      ),
    );
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0x0A64D2FF),
