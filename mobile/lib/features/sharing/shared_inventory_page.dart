...
class _SharedInventoryPageState extends State<SharedInventoryPage>
  ...
  Color _colorForName(String name) {
    const colors = [
      Color(0xFF7CA2E4), Color(0xFF30D158), Color(0xFFFF9F0A),
      Color(0xFFFF375F), Color(0xFFBF5AF2), Color(0xFF7CA2E4),
    ];
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0x0A7CA2E4),
                      foregroundColor: const Color(0xFF7CA2E4),
                      elevation: 0,
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(14)),
                    ),
