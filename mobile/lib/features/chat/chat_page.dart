...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _submit(String text) async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _messages.add(_ChatMessage(role: _Role.assistant, text: out.assistantMessage.isEmpty ? 'Done.' : out.assistantMessage));
      });
                          ...
                          child: ConstrainedBox(
                            ...
                            child: GlassCard(
                              ...
                              child: Text(
                                m.text,
                                style: TextStyle(
                                  color: Colors.white.withValues(alpha: m.role == _Role.user ? 0.92 : 0.82),
                                  height: 1.25,
                                ),
                              ),
                            ),
