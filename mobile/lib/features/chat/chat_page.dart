...
class _ChatPageState extends State<ChatPage> with AutomaticKeepAliveClientMixin {
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF636366).withValues(alpha: 0.10),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: const Color(0xFF636366).withValues(alpha: 0.40), width: 1),
                      ),
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.add, color: Color(0xFF636366), size: 16),
                          SizedBox(width: 6),
                          Text('New Chat', style: TextStyle(color: Color(0xFF636366), fontSize: 14, fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                  ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          if (isActive)
                                            const Icon(Icons.radio_button_checked, color: Color(0xFF636366), size: 12),
                                        ],
                                      ),
                                    ),
                                  ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.auto_awesome_rounded, color: Color(0xFF636366), size: 25),
            ),
  ...
  MarkdownStyleSheet _assistantMarkdownStyle() => MarkdownStyleSheet(
    ...
    listBullet: const TextStyle(color: Color(0xFF636366), fontSize: 16, height: 1.42),
    blockSpacing: 8,
    listIndent: 18,
  );
              ...
              Row(
                children: [
                  Container(
                    ...
                    height: 24,
                    decoration: BoxDecoration(
                      color: const Color(0xFF636366).withValues(alpha: 0.15),
                      shape: BoxShape.circle,
                    ),
                    child: const Icon(Icons.auto_awesome_rounded, color: Color(0xFF636366), size: 13),
                  ),
              ...
              if (!isTyping && message.navHint != null)
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: const Color(0xFF636366).withValues(alpha: 0.14), borderRadius: BorderRadius.circular(10)),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(message.navHint!['type'] == 'project_kit' ? Icons.construction_outlined : Icons.folder_open_outlined, color: const Color(0xFF636366), size: 15),
                        const SizedBox(width: 7),
                        Flexible(child: Text(_navHintLabel(message.navHint!), overflow: TextOverflow.ellipsis, style: const TextStyle(color: Color(0xFF636366), fontSize: 13, fontWeight: FontWeight.w600))),
                        const SizedBox(width: 5),
                        const Icon(Icons.chevron_right_rounded, color: Color(0xFF636366), size: 17),
                      ],
                    ),
                  ),
                ),
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(
                      ...
                      color: _isListening ? const Color(0xFF636366) : Colors.white38,
                      size: 21,
                    ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: _sending && !_canQueueFollowUp ? const Color(0xFF2C2C2E) : const Color(0xFF636366),
                      ),
