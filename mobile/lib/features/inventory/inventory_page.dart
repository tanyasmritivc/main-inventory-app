      ...
      builder: (sheetContext) => SafeArea(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            ListTile(leading: const Icon(Icons.fact_check_outlined, color: Color(0xFFFF9F0A)), title: const Text('Build Readiness'), onTap: () { Navigator.pop(sheetContext); _openBuildReadiness(); }),
            ListTile(leading: const Icon(Icons.inventory_2_outlined, color: Color(0xFFFF9F0A)), title: const Text('Project Kits'), onTap: () { Navigator.pop(sheetContext); _openProjectKits(); }),
          ]),
        ),
      ),
    );
          ...
          SliverToBoxAdapter(
            child: _spacesError
                ...
                : Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.add_box_outlined, color: Color(0xFFFF9F0A), size: 20),
                        SizedBox(width: 10),
                        Expanded(
                          child: Text(
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: const Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.add_circle_outline_rounded, color: Color(0xFFFF9F0A), size: 28),
                  SizedBox(height: 10),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.folder_rounded, color: Color(0xFFFF9F0A), size: 23),
                          ),
                          const Spacer(),
                          if (lowStock > 0)
                            Container(
