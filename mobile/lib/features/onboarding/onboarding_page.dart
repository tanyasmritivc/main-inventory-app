  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        Icon(
          icon,
          color: muted ? const Color(0xFF8E8E93) : const Color(0xFF636366),
          size: 28,
        ),
        const Spacer(),
        Text(
    ...
    child: Row(
      children: [
        Container(
          ...
          height: 38,
          decoration: BoxDecoration(
            color: const Color(0x26636366),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Icon(icon, color: const Color(0xFF636366), size: 20),
        ),
      ...
      children: [
        ...
        const Row(
          ...
          children: [
            CircleAvatar(
              radius: 14,
              backgroundColor: Color(0x26636366),
              child: Icon(
